...
{
public:
    explicit NumericTableWidgetItem(const QString &txt = QString())
...
QTreeWidget* SelectFunctionDialog::GetTreeWidget() const
{
...
{
    // Ensure functionTree is in the layout
    if (ui->functionTree->parent() == nullptr) {
         ui->gridLayout->addWidget(ui->functionTree, 8, 0, 1, 2);
         //ui->functionTree->show();
    }
