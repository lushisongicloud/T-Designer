    ...
    : QDialog(parent)
{
    ...
    configLayout->addWidget(m_chkReverseOrder);
...
void BatchAutoGenerateDialog::createWorkerTab(int workerId, const QString &code, const QString &name, int equipmentId)
{
    // 如果已存在，先删除旧的
