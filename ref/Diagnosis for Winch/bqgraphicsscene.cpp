...
void BQGraphicsScene::SetBackGroundImage(QPixmap pix, int width, int height)
{
//    width=width-10;
//    height=height-10;
//    this->clear();
...
////    _backGroundItem->setPos(0,0);
    ...
    // 计算图像居中所需的位置
    qreal x = (width - pix.width() * scale) / 2;
    qreal y = (height - pix.height() * scale) / 2;
    _backGroundItem->setPos(x, y);
}
