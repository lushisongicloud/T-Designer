...
private:
    ...
    QString createRangePredicate(const QString &expression, double lower, double upper) const;
    QString formatDouble(double value) const;
    bool isSatCached(const SmtFacade &smt, const QString &code, int timeoutMs) const;
